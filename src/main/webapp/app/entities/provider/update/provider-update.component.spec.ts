...
describe('Provider Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('Should call Client query and add missing value', () => {
      const provider: IProvider = { id: 456 };
      const clients: IClient[] = [{ id: 8032 }];
      provider.clients = clients;

      const clientCollection: IClient[] = [{ id: 10804 }];
    ...
    it('Should call Delivery query and add missing value', () => {
      const provider: IProvider = { id: 456 };
      const deliveries: IDelivery[] = [{ id: 17283 }];
      provider.deliveries = deliveries;

      const deliveryCollection: IDelivery[] = [{ id: 776 }];
    ...
    it('Should update editForm', () => {
      ...
      provider.user = user;
      const client: IClient = { id: 20032 };
      provider.clients = [client];
      const delivery: IDelivery = { id: 26081 };
