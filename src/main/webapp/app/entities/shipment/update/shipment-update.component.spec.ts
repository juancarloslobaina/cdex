...
describe('Shipment Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('Should call Provider query and add missing value', () => {
      const shipment: IShipment = { id: 456 };
      const provider: IProvider = { id: 15332 };
      shipment.provider = provider;

      const providerCollection: IProvider[] = [{ id: 21072 }];
    ...
    it('Should call Delivery query and add missing value', () => {
      const shipment: IShipment = { id: 456 };
      const delivery: IDelivery = { id: 4830 };
      shipment.delivery = delivery;

      const deliveryCollection: IDelivery[] = [{ id: 32084 }];
    ...
    it('Should call Beneficiary query and add missing value', () => {
      const shipment: IShipment = { id: 456 };
      const beneficiary: IBeneficiary = { id: 1153 };
      shipment.beneficiary = beneficiary;

      const beneficiaryCollection: IBeneficiary[] = [{ id: 20822 }];
    ...
    it('Should update editForm', () => {
      ...
      shipment.client = client;
      const provider: IProvider = { id: 23987 };
      shipment.provider = provider;
      const delivery: IDelivery = { id: 5469 };
      shipment.delivery = delivery;
      const beneficiary: IBeneficiary = { id: 32152 };
      shipment.beneficiary = beneficiary;
